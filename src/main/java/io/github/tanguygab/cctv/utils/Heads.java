...
public enum Heads {
    ...
    MENU_PREVIOUS("YTE4NWM5N2RiYjgzNTNkZTY1MjY5OGQyNGI2NDMyN2I3OTNhM2YzMmE5OGJlNjdiNzE5ZmJlZGFiMzVlIn19fQ==", CCTV.get().getLang().GUI_COMPUTER_DEFAULT_ITEM_PREVIOUS_PAGE), // Arrow Left Iron
    MENU_NEXT("MzFjMGVkZWRkNzExNWZjMWIyM2Q1MWNlOTY2MzU4YjI3MTk1ZGFmMjZlYmI2ZTQ1YTY2YzM0YzY5YzM0MDkxIn19fQ==", CCTV.get().getLang().GUI_COMPUTER_DEFAULT_ITEM_NEXT_PAGE), // Arrow Right Iron
